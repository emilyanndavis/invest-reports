...
def report(file_registry: dict, args_dict: dict, model_spec: ModelSpec,
    ...
    lulc_pre_caption = (
        ...
        'first). If your LULC raster has a raster attribute table (RAT), you '
        'can find that table in the "LULC Attribute Tables" section of this '
        'report.')

    lulc_attr_table_tuples = [(
            os.path.basename(args_dict[lulc_id]),
            utils.rat_to_html(args_dict[lulc_id])
